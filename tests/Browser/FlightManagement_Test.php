...
class FlightManagement_Test extends DuskTestCase
{
    ...
    public function testAddFlightSuccess_TC_TCB_01()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->type('[id="data.ma_chuyen_bay"]', 'VN123');
    ...
    // TC_TCB_02: Thành công - Nút Tạo & Tiếp tục
    public function testAddFlightSuccess_Another_TC_TCB_02()
    {
        $this->browse(function (Browser $browser) {
    ...
    public function testAddFlightFailed_EmptyCode_TC_TCB_03()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyAirplane_TC_TCB_04()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyDeparture_TC_TCB_05()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyArrival_TC_TCB_06()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyStatus_TC_TCB_07()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyDepartureTime_TC_TCB_08()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyArrivalTime_TC_TCB_09()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_EmptyPrice_TC_TCB_10()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_DuplicateCode_TC_TCB_11()
    {
        $this->browse(function (Browser $browser) {
            $maTrung = 'VN123';
            $this->setUpAdmin($browser);
    ...
    public function testAddFlightFailed_SpecialCharCode_TC_TCB_12()
    {
        $this->browse(function (Browser $browser) {
            $this->setUpAdmin($browser);
            $browser->visit('/admin/chuyen-bays/create')
    ...
    public function testAddFlightFailed_PriceZero_TC_TCB_13()
    {
        $this->browse(function (Browser $browser) {
            ...
            $this->setFilamentDateTime($browser, 'data.thoi_gian_den', '2026-10-25 10:00:00');
            $browser->click('[dusk="filament.admin.action.create"]');
            $browser->waitForText('Giá vé phải lớn hơn 0.', 50)
    ...
    public function testAddFlightFailed_PriceIsString_TC_TCB_15()
    {
        $this->browse(function (Browser $browser) {
            ...
            $this->setFilamentDateTime($browser, 'data.thoi_gian_den', '2026-10-25 10:00:00');
            $browser->click('[dusk="filament.admin.action.create"]')->pause(1000);
            $browser->waitForText('Giá vé phải là số.', 10)
